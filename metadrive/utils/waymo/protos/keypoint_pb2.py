...
from metadrive.utils.waymo_utils.protos import vector_pb2 as waymo__open__dataset_dot_protos_dot_vector__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        waymo__open__dataset_dot_protos_dot_vector__pb2.DESCRIPTOR,
    ]
)
...
_KEYPOINTTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='KEYPOINT_TYPE_LEFT_SHOULDER', index=2, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            name='KEYPOINT_TYPE_RIGHT_SHOULDER', index=8, number=13, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name='KEYPOINT_TYPE_RIGHT_ELBOW', index=9, number=14, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name='KEYPOINT_TYPE_RIGHT_WRIST', index=10, number=15, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            name='KEYPOINT_TYPE_RIGHT_ANKLE', index=13, number=18, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name='KEYPOINT_TYPE_FOREHEAD', index=14, number=19, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name='KEYPOINT_TYPE_HEAD_CENTER', index=15, number=20, serialized_options=None, type=None
        ),
    ],
