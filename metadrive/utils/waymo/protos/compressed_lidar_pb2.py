...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        waymo__open__dataset_dot_dataset__pb2.DESCRIPTOR,
    ]
)
...
_COMPRESSEDFRAMELASERDATA.fields_by_name['laser_calibrations'
                                         ].message_type = waymo__open__dataset_dot_dataset__pb2._LASERCALIBRATION
